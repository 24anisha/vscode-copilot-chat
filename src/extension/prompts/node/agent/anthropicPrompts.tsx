	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='instructions'>
				...
				{tools[ToolName.SearchSubagent] && <>For context searching that requires exploration, use {ToolName.SearchSubagent} to more thoroughly understand instead of directly calling {ToolName.FindTextInFiles}, {ToolName.Codebase} or {ToolName.FindFiles}.<br /></>}
